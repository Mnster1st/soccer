...
export const SEASON_SCHEDULE:Schedule [] = [
    ...
    AwayTeam: 'RRQ',HomeScore:3, AwayScore:0, RefName:'Sukasjo',
    notes:'Pertandingan melelahkan'},
    {id: 3, PlayingDate: new Date (2021,08,12),HomeTeam: 'Evos',
    AwayTeam: 'Persis Solo',HomeScore:2, AwayScore:0, RefName:'Joko',
    notes:'Pertandingan agak aneh'},
    {id: 4, PlayingDate: new Date (2021,08,13),HomeTeam: 'Persipon',
    AwayTeam: 'Persija',HomeScore:3, AwayScore:0, RefName:'Sukasjo',
    notes:'Pertandingan dimenangkan persipon'},
    {id: 5, PlayingDate: new Date (2021,08,14),HomeTeam: 'MU',
    AwayTeam: 'Real Madrid',HomeScore:2, AwayScore:4, RefName:'Taufik',
    notes:'Pertandingan overtime'},
]
